...
in    s.list
        (   c.base1 (t.active (t.selection t.background))
          # c.base3 (t.active (t.selection t.foreground))
          # c.unset (t.drop t.background)
          # c.pointOut (t.focus t.background)
          # c.unset (t.focus t.foreground)
          # c.yellow (t.highlight t.foreground)
          # c.base01 (t.hover t.background)
          # c.base1 (t.hover t.foreground)
          # c.base00 (t.inactive (t.selection t.background))
